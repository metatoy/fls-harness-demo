...
test('share text reads calmly', (t) => {
  t.is(
    dailyShareText(142, 2, 6, 34),
    'pocket daily #142 · 2nd of 6 · 34 hands · pocket.n8plusus.com',
  )
  t.is(dailyShareText(3, 1, 5, 21), 'pocket daily #3 · won it · 21 hands · pocket.n8plusus.com')
  t.is(dailyShareText(9, null, 5, 1), 'pocket daily #9 · played · 1 hand · pocket.n8plusus.com')
})
